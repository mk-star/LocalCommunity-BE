package com.example.backend.domain.mypage.service;
...
import com.example.backend.domain.post_scrap.PostScrap;
import com.example.backend.domain.post_scrap.PostScrapDto;
import com.example.backend.domain.post_scrap.PostScrapRepository;
import com.example.backend.domain.user.User;
import com.example.backend.domain.user.UserDto;
