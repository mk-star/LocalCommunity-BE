...
public class PostCommandServiceImpl implements PostCommandService {
    ...
    public Post createPost(PostRequestDTO.CreatePostRequestDTO request, Long userId) {
        ...
        Category category = categoryRepository.findById(request.getCategoryId()).orElseThrow(() -> new CategoryException(CategoryErrorCode.CATEGORY_NOT_FOUND));
    ...
    public List<PostImage> uploadImage(List<MultipartFile> images) {
        List<String> pictureUrls = s3Service.uploadFile(images);
